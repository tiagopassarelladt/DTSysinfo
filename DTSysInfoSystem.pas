...
type
  ...
  public
    ...
    ///  <remarks>When this method returns True public methods of TDTOSInfo
    ...
    class function Platform: TDTOSPlatform;

    ///  <summary>Returns the host OS product identifier.</summary>
    class function Product: TDTOSProduct;
    ...
    ///  and returns the same value as TDTOSInfo.IsServer.</para>
...
type
  ...
  public
    ...
    class function BootMode: TDTBootMode;
...
type
  ...
  ///  folders.</summary>
  TDTSystemFolders = class(TObject)
  public
...
const
  ...
  //  * Beta channel: revs 160,290,436,440,450,575,586,590,598,601,730
  //  * Release Preview channel: revs 105,169,232,317,457,607
  //  * Public Release: revs 382,521,525,608 & 731 and later
  ...
  Win11DevChannelDevBuilds: array[0..41] of Integer = (
    // pre Win 11 release
  ...
  WinServerSimpleBuildMap: array[0..12] of TBuildNameMap = (
    // Windows Server 2016
    (Build: 10074; Name: 'Technical Preview 2'),
    (Build: 10514; Name: 'Technical Preview 3'),
    (Build: 10586; Name: 'Technical Preview 4'),
    (Build: 14300; Name: 'Technical Preview 5'),
    (Build: 14393; Name: 'Version 1607'),
    (Build: 16299; Name: 'Version 1709'),
    (Build: Win2016LastBuild; Name: 'Version 1803'),
    // Windows Server 2019
    (Build: 17763; Name: 'Version 1809'),
    (Build: 18362; Name: 'Version 1903'),
    (Build: Win2019LastBuild; Name: 'Version 1909'),
    // Windows Server (no year number)
    (Build: 19041; Name: 'Version 2004'),
    (Build: WinServerLastBuild; Name: 'Version 20H2'),
    // Windows Sever 2022
    (Build: 20348; Name: 'Version 21H2')
  );
...
// using TDTOSInfo to ensure that an infinite loop is not set up with TDTOSInfo
    ...
    begin
      ...
      case ValueInfo.RegData of
        ...
        rdInteger:
          ...
          raise EDTSysInfoSystem.Create(sBadRegType);
      end;
    end;
  finally
    // Close registry
  ...
  try
    ...
    begin
      ...
      if ValueInfo.RegData <> rdInteger then
        raise EDTSysInfoSystem.Create(sBadRegIntType);
          ...
          begin
            ...
            begin
              ...
              case InternalRevisionNumber of
                ...
                105, 169, 232, 317, 457, 607:
                  InternalExtraUpdateInfo := Format(
                    'Version 22H2 [Release Preview v10.0.%d.%d]',
                    [InternalBuildNumber, InternalRevisionNumber]
                  );
                160, 290, 436, 440, 450, 575, 586, 590, 598, 601, 730:
                  InternalExtraUpdateInfo := Format(
...
class function TDTOSInfo.BuildNumber: Integer;
begin
  Result := InternalBuildNumber;
end;

class function TDTOSInfo.CanSpoof: Boolean;
begin
  Result := UseGetVersionAPI;
end;

class function TDTOSInfo.CheckSuite(const Suite: Integer): Boolean;
begin
  Result := Win32SuiteMask and Suite <> 0;
end;

class function TDTOSInfo.Description: string;
...
class function TDTOSInfo.Edition: string;
begin
...
class function TDTOSInfo.EditionFromProductInfo: string;
var
...
class function TDTOSInfo.EditionFromReg: string;
var
...
class function TDTOSInfo.HasPenExtensions: Boolean;
begin
  Result := GetSystemMetrics(SM_PENWINDOWS) <> 0;
end;

class function TDTOSInfo.InstallationDate: TDateTime;
var
  DateStr: string;
  UnixDate: LongWord;
const
...
class function TDTOSInfo.IsMediaCenter: Boolean;
begin
  Result := GetSystemMetrics(SM_MEDIACENTER) <> 0;
end;

class function TDTOSInfo.IsNT4SP6a: Boolean;
var
  Reg: TRegistry; // registry access object
begin
  if (Product = osWinNT)
...
class function TDTOSInfo.IsReallyWindows2000OrGreater: Boolean;
begin
...
class function TDTOSInfo.IsReallyWindows2000SP1OrGreater: Boolean;
begin
  Result := IsReallyWindowsVersionOrGreater(
...
class function TDTOSInfo.IsReallyWindows2000SP2OrGreater: Boolean;
begin
  Result := IsReallyWindowsVersionOrGreater(
...
class function TDTOSInfo.IsReallyWindows2000SP3OrGreater: Boolean;
begin
  Result := IsReallyWindowsVersionOrGreater(
...
class function TDTOSInfo.IsReallyWindows2000SP4OrGreater: Boolean;
begin
  Result := IsReallyWindowsVersionOrGreater(
...
class function TDTOSInfo.IsReallyWindows7OrGreater: Boolean;
begin
  Result := IsReallyWindowsVersionOrGreater(
...
class function TDTOSInfo.IsReallyWindows7SP1OrGreater: Boolean;
begin
  Result := IsReallyWindowsVersionOrGreater(
...
class function TDTOSInfo.IsReallyWindows8OrGreater: Boolean;
begin
  Result := IsReallyWindowsVersionOrGreater(
...
class function TDTOSInfo.IsReallyWindows8Point1OrGreater: Boolean;
begin
  Result := IsReallyWindowsVersionOrGreater(
...
class function TDTOSInfo.IsReallyWindows10OrGreater: Boolean;
begin
  Result := IsReallyWindowsVersionOrGreater(
...
class function TDTOSInfo.IsReallyWindowsVersionOrGreater(MajorVersion,
...
class function TDTOSInfo.IsReallyWindowsVistaOrGreater: Boolean;
begin
  Result := IsReallyWindowsVersionOrGreater(
...
class function TDTOSInfo.IsReallyWindowsVistaSP1OrGreater: Boolean;
begin
  Result := IsReallyWindowsVersionOrGreater(
...
class function TDTOSInfo.IsReallyWindowsVistaSP2OrGreater: Boolean;
begin
  Result := IsReallyWindowsVersionOrGreater(
...
class function TDTOSInfo.IsReallyWindowsXPOrGreater: Boolean;
begin
  Result := IsReallyWindowsVersionOrGreater(
...
class function TDTOSInfo.IsReallyWindowsXPSP1OrGreater: Boolean;
begin
  Result := IsReallyWindowsVersionOrGreater(
...
class function TDTOSInfo.IsReallyWindowsXPSP2OrGreater: Boolean;
begin
  Result := IsReallyWindowsVersionOrGreater(
...
class function TDTOSInfo.IsReallyWindowsXPSP3OrGreater: Boolean;
begin
  Result := IsReallyWindowsVersionOrGreater(
...
class function TDTOSInfo.IsRemoteSession: Boolean;
begin
  Result := GetSystemMetrics(SM_REMOTESESSION) <> 0;
end;

class function TDTOSInfo.IsServer: Boolean;
begin
...
class function TDTOSInfo.IsTabletPC: Boolean;
begin
  Result := GetSystemMetrics(SM_TABLETPC) <> 0;
end;

class function TDTOSInfo.IsWin32s: Boolean;
begin
  Result := Platform = ospWin32s;
end;

class function TDTOSInfo.IsWin9x: Boolean;
begin
  Result := Platform = ospWin9x;
end;

class function TDTOSInfo.IsWindowsServer: Boolean;
var
  OSVI: TOSVersionInfoEx;
...
class function TDTOSInfo.IsWinNT: Boolean;
begin
  Result := Platform = ospWinNT;
end;

class function TDTOSInfo.IsWow64: Boolean;
type
...
class function TDTOSInfo.MajorVersion: Integer;
begin
  Result := InternalMajorVersion;
end;

class function TDTOSInfo.MinorVersion: Integer;
begin
  Result := InternalMinorVersion;
end;

class function TDTOSInfo.Platform: TDTOSPlatform;
begin
  case InternalPlatform of
    ...
    else raise EDTSysInfoSystem.Create(sUnknownPlatform);
  end;
end;

class function TDTOSInfo.Product: TDTOSProduct;
begin
  Result := osUnknown;
  case Platform of
    ospWin9x:
...
class function TDTOSInfo.ProductID: string;
begin
...
class function TDTOSInfo.ProductName: string;
begin
  case Product of
    ...
    osWinServer: Result := 'Windows Server';
      ...
      raise EDTSysInfoSystem.Create(sUnknownProduct);
  end;
end;

class function TDTOSInfo.ProductTypeFromReg: string;
begin
  Result := GetRegistryString(
    HKEY_LOCAL_MACHINE,
...
class function TDTOSInfo.RegisteredOrganisation: string;
begin
  Result := GetRegistryString(
...
class function TDTOSInfo.RegisteredOwner: string;
begin
  Result := GetRegistryString(
...
class function TDTOSInfo.RevisionNumber: Integer;
begin
  Result := InternalRevisionNumber;
end;

class function TDTOSInfo.ServicePack: string;
begin
...
class function TDTOSInfo.ServicePackEx: string;
begin
  Result := ServicePack;
  if Result = '' then
...
class function TDTOSInfo.ServicePackMajor: Integer;
begin
  Result := Win32ServicePackMajor;
end;

class function TDTOSInfo.ServicePackMinor: Integer;
begin
...
class function TDTComputerInfo.BiosVendor: string;
begin
  Result := GetRegistryString(
    HKEY_LOCAL_MACHINE,
...
class function TDTComputerInfo.BootMode: TDTBootMode;
begin
...
class function TDTComputerInfo.ComputerName: string;
var
...
class function TDTComputerInfo.Is64Bit: Boolean;
begin
  Result := Processor in [paX64, paIA64];
end;

class function TDTComputerInfo.IsAdmin: Boolean;
const
...
class function TDTComputerInfo.IsNetworkPresent: Boolean;
begin
  Result := GetSystemMetrics(SM_NETWORK) and 1 = 1;
end;

class function TDTComputerInfo.IsUACActive: Boolean;
var
  Reg: TRegistry;   // registry access object
begin
  Result := False;
  if not TDTOSInfo.IsWinNT or (TDTOSInfo.MajorVersion < 6) then
...
class function TDTComputerInfo.MACAddress: string;
type
...
class function TDTComputerInfo.Processor: TDTProcessorArchitecture;
begin
...
class function TDTComputerInfo.ProcessorCount: Cardinal;
var
...
class function TDTComputerInfo.ProcessorIdentifier: string;
begin
  Result := GetRegistryString(
    HKEY_LOCAL_MACHINE,
...
class function TDTComputerInfo.ProcessorName: string;
begin
  Result := GetRegistryString(
    HKEY_LOCAL_MACHINE,
    'HARDWARE\DESCRIPTION\System\CentralProcessor\0\',
...
class function TDTComputerInfo.ProcessorSpeedMHz: Cardinal;
begin
  Result := Cardinal(
    GetRegistryInt(
      HKEY_LOCAL_MACHINE,
...
class function TDTComputerInfo.SystemManufacturer: string;
begin
  Result := GetRegistryString(
    HKEY_LOCAL_MACHINE,
    'HARDWARE\DESCRIPTION\System\Bios\',
...
class function TDTComputerInfo.SystemProductName: string;
begin
  Result := GetRegistryString(
    HKEY_LOCAL_MACHINE,
    'HARDWARE\DESCRIPTION\System\Bios\',
...
class function TDTComputerInfo.UserName: string;
const
...
class function TDTSystemFolders.CommonFiles: string;
begin
...
class function TDTSystemFolders.CommonFilesRedirect: string;
begin
  Result := GetEnvVar('COMMONPROGRAMFILES');
end;

class function TDTSystemFolders.CommonFilesX86: string;
begin
  Result :=  ExcludeTrailingPathDelimiter(
...
class function TDTSystemFolders.ProgramFiles: string;
begin
  Result :=  ExcludeTrailingPathDelimiter(
...
class function TDTSystemFolders.ProgramFilesRedirect: string;
begin
  Result := GetEnvVar('PROGRAMFILES');
end;

class function TDTSystemFolders.ProgramFilesX86: string;
begin
  Result :=  ExcludeTrailingPathDelimiter(
...
class function TDTSystemFolders.System: string;
var
...
class function TDTSystemFolders.SystemWow64: string;
type
...
class function TDTSystemFolders.Temp: string;
var
...
class function TDTSystemFolders.Windows: string;
var
  PFolder: array[0..MAX_PATH] of Char;  // buffer to hold name returned from API
begin
